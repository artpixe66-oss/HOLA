  ...
  return (
    <div className="grid min-h-[60vh] place-items-center">
      <form method="post" action="/api/login" className="w-full max-w-sm space-y-4 rounded-[28px] bg-white p-6 text-black">
        ...
        <input name="password" type="password" autoFocus required placeholder="Mot de passe" className="w-full rounded-2xl border border-black/10 bg-black/5 px-4 py-3 outline-none focus:border-black" />
